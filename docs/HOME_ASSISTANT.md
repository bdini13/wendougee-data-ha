...
live start observed cleaning then idle with unchanged settings; the owner confirmed
all three physical repetitions and normal completion. Installation does not run a cycle.
