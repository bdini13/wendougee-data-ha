...
At the 2026-09-22 checkpoint, version 0.1.0 is installed on the target HA host and has completed advancing read-only polling through the ESPHome proxy. Its activity analytics and Espresso dashboard are live; the schedule helpers are inert. The boiler frame builders remain unreachable from Home Assistant and have not been sent to hardware. Current support claims belong in the README and capability map, not in model-generated confidence statements.
