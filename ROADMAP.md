...
- [ ] Run a controlled second-central or alternate-proxy A/B test before changing machine state. Treat an ESPHome firmware pin/downgrade as a separate rollback-safe maintenance experiment, not a read-only test; the closely related 2026.8 regression was already fixed in the installed 2026.9.0 release and failed at a later connection phase.
