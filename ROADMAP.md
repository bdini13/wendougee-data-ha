...
- [ ] Exclude mobile-app/single-central contention, then test a materially different BLE stack or a rollback-safe proxy firmware matrix. Another original ESP32 on the same 2026.9.0 stack is no longer a useful discriminator.
