...
| HA integration | Version 0.1.2 installed after backup/configuration check and a healthy restart; corrected benchmark selected 2 Hz for complete telemetry/state pairs; no write path is exposed |
